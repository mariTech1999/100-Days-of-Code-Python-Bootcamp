...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas.grid(pady=20, row=1, column=0, columnspan=2)
        self.question = canvas.create_text(150,125, width=280, font=FONT, text="QUIZ")
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question, text = "The end of the Quiz!!")
